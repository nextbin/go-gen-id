...
func init() {
	proto.RegisterType((*GenIdRequest)(nil), "service_pb.GenIdRequest")
	proto.RegisterType((*GenIdResponse)(nil), "service_pb.GenIdResponse")
}
...
var fileDescriptor_ce21d2510d3ac9c9 = []byte{
	...
	0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0xe2, 0x2a, 0x4e, 0x2d, 0x2a, 0xcb, 0x4c, 0x4e, 0x8d, 0x2f,
	0x48, 0x52, 0xe2, 0xe3, 0xe2, 0x71, 0x4f, 0xcd, 0xf3, 0x4c, 0x09, 0x4a, 0x2d, 0x2c, 0x4d, 0x2d,
	0x2e, 0x51, 0x32, 0xe6, 0xe2, 0x85, 0xf2, 0x8b, 0x0b, 0xf2, 0xf3, 0x8a, 0x53, 0x85, 0x84, 0xb8,
	0x58, 0x92, 0xf3, 0x53, 0x52, 0x25, 0x18, 0x15, 0x18, 0x35, 0x58, 0x83, 0xc0, 0x6c, 0x21, 0x3e,
	0x2e, 0xa6, 0xcc, 0x14, 0x09, 0x26, 0x05, 0x46, 0x0d, 0xe6, 0x20, 0xa6, 0xcc, 0x14, 0x23, 0x57,
	0x2e, 0x66, 0xf7, 0xd4, 0x3c, 0x21, 0x3b, 0x2e, 0x56, 0xb0, 0x5e, 0x21, 0x09, 0x3d, 0x84, 0x0d,
	0x7a, 0xc8, 0xc6, 0x4b, 0x49, 0x62, 0x91, 0x81, 0x58, 0xa4, 0xc4, 0x90, 0xc4, 0x06, 0x76, 0x9e,
	0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0xde, 0x5a, 0xbd, 0x1e, 0xab, 0x00, 0x00, 0x00,
}
...
func (c *genClient) GenId(ctx context.Context, in *GenIdRequest, opts ...grpc.CallOption) (*GenIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/service_pb.Gen/GenId", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Gen_GenId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/service_pb.Gen/GenId",
	}
